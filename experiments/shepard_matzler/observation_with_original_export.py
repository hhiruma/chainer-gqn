        ...
        for subset in dataset:
            ...
            for data_indices in iterator:
                ...
                for t in range(total_frames_per_rotation):
                    ...
                    np.save(os.path.join(args.output_directory, 'zero_shape.npy'), [to_cpu(generated_images[0]), to_cpu(current_scene_original_images[t])])
                    break
                ...
                for m in range(num_views_per_scene):
                    ...
                    for t in range(total_frames_per_rotation):
                        ...
                        np.save(os.path.join(args.output_directory, 'gen_shape.npy'), [to_cpu(generated_images[0]), to_cpu(current_scene_original_images[t])])
                        break
                sys.exit(1)
